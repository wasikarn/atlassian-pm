...
>
> ```bash
> uv run scripts/api/validate_adf.py {{artifacts_dir}}/tp-xxx-update.json --type subtask --json
> ```
>
...
[Update Workflow Patterns](../../../references/update-workflow.md) · [ADF Core Rules](../../../references/templates-core.md) · [Subtask Template](../../../references/templates-subtask.md) · [Tool Selection](../../../references/tools.md)
