...
>
> ```bash
> uv run scripts/api/validate_adf.py {{artifacts_dir}}/tp-xxx-update.json --type task --json
> ```
>
...
[Update Workflow Patterns](../../../references/update-workflow.md) · [ADF Core Rules](../../../references/templates-core.md) · [Task Template](../../../references/templates-task.md)
