...
[Sprint Frameworks](../../../references/sprint-frameworks.md) · [Team Capacity](../../../references/team-capacity.md) · [Skill Orchestration](../../../references/skill-orchestration.md) · [Mermaid Guide](../../../references/mermaid-guide.md) · [apm-pretty-mermaid](../../utilities/apm-pretty-mermaid/SKILL.md) (ASCII for Jira comments; raw `.mmd` in Forge Mermaid macro for Confluence review page)
