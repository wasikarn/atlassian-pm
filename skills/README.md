...
| apm-pretty-mermaid | `/atlassian-pm:apm-pretty-mermaid` | — | node 18+ | Render Mermaid → ASCII (default, for Jira ADF code blocks) or themed SVG (for Confluence). Wraps beautiful-mermaid with APM-aware defaults. |
