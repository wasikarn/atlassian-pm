...
> Per-member raw throughput: see `project-config.json → team.members[].avg_throughput`.
...
> Review load should be factored into capacity planning for reviewers managing junior engineers.
